...
<body>
	...
	*/
	...
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); // Varsayılan hal false yapısıdır. (true yapısı oluşursa ekrana gelmez.)
	
	$Sonuc	 	= curl_exec($ch); // CURLOPT_RETURNTRANSFER sayesinde sonuc değerine bir referans depolandı.
	curl_close($ch);
