...
<body>
	...
	*/
	$Oturum 	= curl_init();
	curl_setopt($Oturum, CURLOPT_URL, "http://127.0.0.1/PHPdersleri/PC_7.3_sonuc.php");
	curl_setopt($Oturum, CURLOPT_RETURNTRANSFER, true);
	curl_setopt($Oturum, CURLOPT_REFERER, "https://www.google.com.tr"); // extraegitim.com'dan geldim diyoruz.
