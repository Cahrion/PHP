...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler WHERE id>? AND id<?"); 
	
	// İstenirse bu şekilde de yapılabilir.
	$Sorgu->bindParam(1, $IlkDeger, PDO::PARAM_INT); // Ilk parametre sıra numarası ikinci getirilecek değer (Değişken yazılması zorunlu.) üçüncü değer değerin veri türü.
