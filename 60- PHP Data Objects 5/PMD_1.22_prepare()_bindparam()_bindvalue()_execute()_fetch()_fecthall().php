...
<body>
	...
	*/
	...
	$Sorgu->bindvalue("KullaniciAD", $GelenIsim, PDO::PARAM_STR); // Bu yapıyla da yapılabilir. (Isim yapısı eklenerek.)
 	$Sorgu->bindvalue("KullaniciEmail", $GelenMail, PDO::PARAM_STR);
	$Sorgu->bindvalue("KullaniciSif", $GelenSifre, PDO::PARAM_STR);
	$Sorgu->bindvalue("Kullanicitel", $GelenTelefon, PDO::PARAM_STR);
	$Sorgu->bindvalue("KullaniciYas",  $GelenYas, PDO::PARAM_INT);
	$Sorgu->bindvalue("KullaniciCins", $GelenCinsiyet, PDO::PARAM_STR);
	$Sorgu->bindvalue("KullaniciSehir",  $GelenSehir, PDO::PARAM_STR);
