...
<body>
	...
	*/
	...
	$Sorgu->bindparam(1, $GelenArananDeger, PDO::PARAM_STR); // Bu şekilde de kullanılabilir (Isim etiketleriyle de kullanılabilir.)
	$Sorgu->bindparam(2, $GelenDegisenDeger, PDO::PARAM_STR);
	$Sorgu->bindparam(3, $GelenIDDeger, PDO::PARAM_INT);
