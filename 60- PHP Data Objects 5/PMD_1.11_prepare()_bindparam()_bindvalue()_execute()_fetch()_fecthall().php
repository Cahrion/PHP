...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler WHERE id>:IDIlkKosul AND id<:IDSonKosul"); // soru işareti yerine (bir isim verilebilir.)
	$Sorgu->execute(["IDIlkKosul" => 2,"IDSonKosul" => 5]);
		if($Sorgu){
