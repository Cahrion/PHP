...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler WHERE id>:IDIlkKosul AND id<:IDSonKosul"); // Ek bir isim belirttik.
	
	
	$Sorgu->bindvalue("IDIlkKosul", $IlkDeger, PDO::PARAM_INT); // Eğer ek bir isim belirtildiyse o veri yazılır.
	$Sorgu->bindvalue("IDSonKosul", $IkinciDeger, PDO::PARAM_INT); // bindvalue yapısıda aynı şekilde çalışır.
