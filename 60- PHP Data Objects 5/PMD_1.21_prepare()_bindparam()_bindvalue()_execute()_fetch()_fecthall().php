...
<body>
	...
	*/
	...
	?)"); 
	$Sorgu->bindvalue(1, $GelenIsim, PDO::PARAM_STR); // Bu yapıyla da yapılabilir. (bindvalue)
	$Sorgu->bindvalue(2, $GelenMail, PDO::PARAM_STR);
	$Sorgu->bindvalue(3, $GelenSifre, PDO::PARAM_STR);
	$Sorgu->bindvalue(4, $GelenTelefon, PDO::PARAM_STR);
	$Sorgu->bindvalue(5, $GelenYas, PDO::PARAM_INT);
	$Sorgu->bindvalue(6, $GelenCinsiyet, PDO::PARAM_STR);
	$Sorgu->bindvalue(7, $GelenSehir, PDO::PARAM_STR);
