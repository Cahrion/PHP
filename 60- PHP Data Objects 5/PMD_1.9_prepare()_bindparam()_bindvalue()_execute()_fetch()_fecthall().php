...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler WHERE id > ?"); // Soru işareti yerine belirtilecek olanları execute içeriğine verilir.
	$Sorgu->execute([2]);// Dizi şeklinde yapılır.
		if($Sorgu){
