...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler WHERE id>? AND id<?"); // Soru işareti yerine belirtilecek olanları execute içeriğine verilir.
	$Sorgu->execute([2,5]);// Dizi şeklinde yapılır. (1. soru işaretine birinci parametre 2. soru işaretine ikinci parametre.)
		if($Sorgu){
