...
<body>
	...
	*/
	...
	// prepare yapısıyla --> Silme (Delete) yapısı
	
	$GelenID= 3;
	
	$Sorgu 	= $VeritabaniBaglantisi->prepare("DELETE FROM kisiler WHERE id=?");  // Delete yapısında da kullanılabilir.

	$Sorgu->bindvalue(1, $GelenID, PDO::PARAM_INT);  // Bu yapıyıda kullanabiliriz. (Isim etiketi verilerek de kullanılabilir.) (bindvalue)
