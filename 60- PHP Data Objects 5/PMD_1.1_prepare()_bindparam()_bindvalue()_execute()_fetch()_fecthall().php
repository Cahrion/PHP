...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT * FROM kisiler", array(PDO::FETCH_ASSOC)); 
	// Dizi yapısıyla bir adlandırma türü belirtebiliyoruz lakin şu anda bir yapı değiştirilmesi çalışmaz. Halen FETCH_BOTH yapısı gibi çalışır.
	$Sorgu->execute();
		if($Sorgu){
