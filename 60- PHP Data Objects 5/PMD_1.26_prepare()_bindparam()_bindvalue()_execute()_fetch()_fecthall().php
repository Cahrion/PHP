...
<body>
	...
	*/
	...
	$Sorgu->bindvalue(1, $GelenIsim, PDO::PARAM_STR); // Bu yapıylada yapılabilir (Isim verilerek de ek olarak yapılabilir.)
	$Sorgu->bindvalue(2, $GelenTel, PDO::PARAM_STR); // Aynı şekilde bindvalue yapısında da olur.
	$Sorgu->bindvalue(3, $GelenYas, PDO::PARAM_INT);
	$Sorgu->bindvalue(4, $GelenID, PDO::PARAM_INT);
