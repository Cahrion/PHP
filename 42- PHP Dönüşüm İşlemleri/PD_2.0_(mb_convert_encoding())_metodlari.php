...
<body>
	...
	*/
	...
	echo $Icerik . "<br>";
	$Islem		= mb_convert_encoding($Icerik, "ISO-8859-9", "UTF-8"); // Içerik, kodlamaya, kodlamadan
	echo $Islem . "<br>";
	$Sonuc		= mb_convert_encoding($Islem, "UTF-8", "ISO-8859-9"); // Içerik, kodlamaya, kodlamadan
	echo $Sonuc;
	?>
</body>
</html>