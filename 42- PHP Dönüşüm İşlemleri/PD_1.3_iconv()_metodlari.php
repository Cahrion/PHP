...
<body>
	...
	*/
	...
	echo $Icerik . "<br>";
	// Parametreler 4. parametre yerine istenen kodlamanın yanına "//" iki adet slash işareti konur ve yapılır.
	$Sonuc 		= iconv("UTF-8", "ISO-8859-1//IGNORE", $Icerik); // Benzer olanları sildi bulamadıklarına kural dışı karakter simgesi koydu.
	echo $Sonuc . "<br>";
