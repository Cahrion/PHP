...
<body>
	...
	$GunBatimiString 			= date_sunset($Zamandamgasi, SUNFUNCS_RET_STRING, 39.913627, 32.850879); 
	$GunBatimiDouble 			= date_sunset($Zamandamgasi, SUNFUNCS_RET_DOUBLE, 39.913627, 32.850879); 
	$GunBatimiTimes 			= date_sunset($Zamandamgasi, SUNFUNCS_RET_TIMESTAMP, 39.913627, 32.850879); 
	
		echo "(String) Gün batımı: " . $GunBatimiString . "<br>";
		echo "(Double) Gün batımı: " . $GunBatimiDouble . "<br>";
		echo "(Timestamp) Gün batımı zaman damgası: " . $GunBatimiTimes . "<br>";
		echo "(Timestamp) Gün batımı düzeni: " . date("H.i", ($GunBatimiTimes - 3600));
