...
<body>
	...
	$Formatla 		=	$Islem->format('%days'); // HATA : "%days" değeri bu şekilde alınmaz çünkü sanki "%d" gibi yazılmış kabul edilir ve sonuna "ays" eklenir
	
		echo "2002-03-28 ile 2001-11-07 arasındaki zaman farkı: " . $Formatla;
	?>
</body>
</html>