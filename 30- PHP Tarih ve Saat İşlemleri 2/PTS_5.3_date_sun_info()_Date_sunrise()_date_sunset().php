...
<body>
	...
	// T.B.M.M Enlem ve Boylam Değerleri
	$GunDogumuString 			= date_sunrise($Zamandamgasi, SUNFUNCS_RET_STRING, 39.913627, 32.850879); 
	$GunDogumuDouble 			= date_sunrise($Zamandamgasi, SUNFUNCS_RET_DOUBLE, 39.913627, 32.850879); 
	$GunDogumuTimes 			= date_sunrise($Zamandamgasi, SUNFUNCS_RET_TIMESTAMP, 39.913627, 32.850879); 
	
		echo "(String) Gün doğumu: " . $GunDogumuString . "<br>";
		echo "(Double) Gün doğumu: " . $GunDogumuDouble . "<br>";
		echo "(Timestamp) Gün doğumu zaman damgası: " . $GunDogumuTimes . "<br>";
		echo "(Timestamp) Gün doğumu düzeni: " . date("H.i", ($GunDogumuTimes - 3600));
