...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kisiler INNER JOIN siparisler ON kisiler.id = siparisler.uyeid INNER JOIN istatistikler ON kisiler.id = istatistikler.uyeid", PDO::FETCH_ASSOC);
	if($Sorgu){
