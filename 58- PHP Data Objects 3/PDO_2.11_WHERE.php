...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler WHERE  FIND_IN_SET('1', beceriseviyeleri)", PDO::FETCH_ASSOC); // Sadece 1 verisi olanları getirir. ("," ile ayrılanlardan.)
	if($Sorgu){
