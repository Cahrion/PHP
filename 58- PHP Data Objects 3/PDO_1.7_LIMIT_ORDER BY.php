...
<body>
	...
	*/	
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler ORDER BY yas ASC, isim ASC", PDO::FETCH_ASSOC); // Aynı yas verisine bağlı şeyleri isim verisinde (A'dan Z'ye) sıralamak için "," ile belirtilir ve ona göre sıralanır.
	if($Sorgu){
