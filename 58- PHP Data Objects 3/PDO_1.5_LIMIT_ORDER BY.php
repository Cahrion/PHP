...
<body>
	...
	*/	
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler ORDER BY yas DESC", PDO::FETCH_ASSOC); // yas yapısını (Z'den A'ya) sıralar numerik ise (büyükten küçüğe) sıralar
	if($Sorgu){
