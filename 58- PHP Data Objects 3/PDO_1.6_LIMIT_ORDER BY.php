...
<body>
	...
	*/	
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler ORDER BY yas ASC, isim DESC", PDO::FETCH_ASSOC); // Aynı yas verisine bağlı şeyleri isim verisinde (Z'den A'ya) sıralamak için "," ile belirtilir ve ona göre sıralanır.
	if($Sorgu){
