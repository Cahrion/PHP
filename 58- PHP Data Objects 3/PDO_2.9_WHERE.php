...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler WHERE isim NOT IN ('aslı', 'icabi', 'Volkan')", PDO::FETCH_ASSOC); // isim değeri aslı, icabi veya Volkan olmayan değerleri getirir.
	if($Sorgu){
