...
<body>
	...
	*/	
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler ORDER BY isim ASC", PDO::FETCH_ASSOC); // isim yapısını (A'dan Z'ye) sıralar numerik ise (küçükten büyüğe) sıralar
	if($Sorgu){
