...
<body>
	...
	*/	
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler ORDER BY isim DESC", PDO::FETCH_ASSOC); // isim yapısını (Z'den A'ya) sıralar numerik ise (büyükten küçüğe) sıralar
	if($Sorgu){
