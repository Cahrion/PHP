...
<body>
	...
	*/
	...
	// INNER yapısıyla aynı işlem çalışabilir. (Siparişler yapısındaki "id" değeri tekrarlandığı için farklı bir yöntemle istenirse alınabilir -> Alias tanımlayarak --> PDO_4.2_JOIN_Işlemleri.php )
	
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kisiler INNER JOIN siparisler ON kisiler.id = siparisler.uyeid", PDO::FETCH_ASSOC);
	if($Sorgu){
