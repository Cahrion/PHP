...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM uyeler WHERE isim IN ('aslı', 'icabi', 'Volkan')", PDO::FETCH_ASSOC); // isim değeri aslı, icabi veya Volkan olan değerleri getirir.
	if($Sorgu){
