...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kisiler NATURAL JOIN istatistikler", PDO::FETCH_ASSOC);
	if($Sorgu){  // Doğru kullanım olur çünkü her iki tarafta belirli sayılarda aynı gidiyor bir bağlılık var.
