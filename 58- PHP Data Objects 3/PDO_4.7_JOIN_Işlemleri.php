...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kisiler RIGHT JOIN siparisler ON kisiler.id = siparisler.uyeid", PDO::FETCH_ASSOC);
	if($Sorgu){ // id değeri bozulur ama alias eklenerek düzenlenir (Sağdaki bütün verileri getirdiği için boş veriler de gelebilir.)
