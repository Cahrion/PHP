...
<body>
	...
	*/
	...
	$IsimlerErkek 	= array(array("Ahmet","Yaprak"),"Deniz",array("Toprak","Erdem"));
	$IsimlerKiz		= array(array("Selin","Pelin"),"Ayşe",array("Selinda"));
	...
	$Sonuc 			= array_replace_recursive($IsimlerErkek, $IsimlerKiz); // Çok boyutlu yapı diğerinden alır kendisininkini direkt almaz.
