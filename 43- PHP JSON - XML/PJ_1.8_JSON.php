...
<body>
	...
	*/
	...
	$Degerler 	= array("<i>Extra Egitim</i>", "Icabi Kırgız", "A'dan Z'ye PHP Görsel Egitim Seti", "27\" Monitor", "HTML & CSS & JS");

	echo "<pre>";
	print_r($Degerler);
	echo "</pre>";
	
	$Donustur 	= json_encode($Degerler, JSON_HEX_AMP|JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT); // Aralara " | " dik çizgi konarak hepsi seçilebilir.  
