...
<body>
	...
	$SonucBir 	= htmlspecialchars($Deger, ENT_COMPAT); // Varsayılan hal
	echo $SonucBir . "<br>"; 
	
	$SonucIki 	= htmlspecialchars($Deger, ENT_QUOTES); // Tek tırnakları dönüşüme aldı.
	echo $SonucIki . "<br>"; 
	
	$SonucUc 	= htmlspecialchars($Deger, ENT_NOQUOTES); // Tek ve çift tırnakları dönüşümden çıkardı.
	echo $SonucUc; 
