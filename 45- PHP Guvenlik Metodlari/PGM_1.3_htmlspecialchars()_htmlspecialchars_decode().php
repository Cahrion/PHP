...
<body>
	...
	$SonucBir 	= htmlspecialchars_decode($Deger, ENT_COMPAT); // (Varsayılan hal)  Geri dönüştürülmüş hal (Tek tırnaklar hariç)
	echo $SonucBir . "<br>"; 
	
	$SonucIki 	= htmlspecialchars_decode($Deger, ENT_QUOTES); // Geri dönüştürülmüş hal (Tamamen dönüştürür.)
	echo $SonucIki . "<br>"; 
	
	$SonucUc 	= htmlspecialchars_decode($Deger, ENT_NOQUOTES); // Geri dönüştürülmüş hal (Tek tırnaklar ve çift tırnaklar hariç)
	echo $SonucUc;
