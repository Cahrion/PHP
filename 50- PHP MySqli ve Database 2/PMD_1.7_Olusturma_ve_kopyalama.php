...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "CREATE TABLE kayitlar LIKE uyeler"); //  Sadece yapiyi kopyalar içindeki verileri kopyalamaz. (uyeler tablosunu kayitlar tablosuna kopyaladı.)
	if($Sorgu){
