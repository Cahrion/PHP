...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "ALTER TABLE uyeler ADD soyisim varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL FIRST"); // FIRST yapısı en başa ekler.
