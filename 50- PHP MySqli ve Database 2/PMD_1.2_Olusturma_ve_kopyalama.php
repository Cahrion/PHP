...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("CREATE DATABASE timetube CHARACTER SET utf8 COLLATE utf8_general_ci"); 
	// Hem veritabanı oluşturduk hemde dili istediğimiz dil yaptık (nesne tabanı ile: timetube)
