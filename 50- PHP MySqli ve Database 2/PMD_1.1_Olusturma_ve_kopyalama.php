...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "CREATE DATABASE cahrion CHARACTER SET utf8 COLLATE utf8_general_ci"); 
	// Hem veritabanı oluşturduk hemde dili istediğimiz dil yaptık (standart yapı ile: cahrion)
