...
<body>
	...
	*/
	...
	$SorguBir 	= mysqli_query($VeritabaniBaglantisi, "CREATE TABLE timetube.kayitlar LIKE cahrion.uyeler"); // İçindeki veritabanını aldı (Farklı veritabanlarıyla)
	if($SorguBir){
		echo "Tablo Kopyalandı. <br>";
		$SorguIki 	= mysqli_query($VeritabaniBaglantisi, "INSERT INTO timetube.kayitlar SELECT * FROM cahrion.uyeler"); // Kayıtlarıda aldı. (Farklı veritabanlarıyla)
		if($SorguIki){
