...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "ALTER TABLE uyeler CHANGE isim soyisim varchar(200) NOT NULL"); // "uyeler" tablosundaki "isim" yapısı "soyisim" ismine çevrildi ve alan yeri 200 oldu
