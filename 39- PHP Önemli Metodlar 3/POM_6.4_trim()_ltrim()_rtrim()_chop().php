...
<body>
	...
	*/
	...
	$Icerik 	= "---Icabi Kırgız---";
		...
		echo $Icerik  . "<br>";
	$lDuzenliIcerik = ltrim($Icerik, "-"); // soldaki 2. parametrede olan veriyi siler.
	$rDuzenliIcerik = rtrim($Icerik, "-"); // sagdaki 2. parametrede olan veriyi siler.
	$cDuzenliIcerik = chop($Icerik, "-"); // sagdaki 2. parametrede olan veriyi siler.
