	...
	*/
	...
	if($Sorgu){
		while($TabloAdi=mysqli_fetch_array($Sorgu)){
			...
			$SorguBir 	= mysqli_query($VeritabaniBaglantisi, "CHECK TABLE " . $TabloAdi[0]);
			$SorguIki 	= mysqli_query($VeritabaniBaglantisi, "ANALYZE TABLE " . $TabloAdi[0]);
			$SorguUc 	= mysqli_query($VeritabaniBaglantisi, "REPAIR TABLE " . $TabloAdi[0]);
			$SorguDort 	= mysqli_query($VeritabaniBaglantisi, "OPTIMIZE TABLE " . $TabloAdi[0]);
