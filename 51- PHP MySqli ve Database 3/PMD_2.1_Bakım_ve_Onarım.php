...
<body>
	...
	*/
	...
	$SorguBir 	= $VeritabaniBaglantisi->query("CHECK TABLE uyeler");
	$SorguIki 	= $VeritabaniBaglantisi->query("ANALYZE TABLE uyeler");
	$SorguUc 	= $VeritabaniBaglantisi->query("REPAIR TABLE uyeler");
	$SorguDort 	= $VeritabaniBaglantisi->query("OPTIMIZE TABLE uyeler");
