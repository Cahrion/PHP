...
<body>
	...
	*/
	...
	$VeritabaniBaglantisi 		= @mysqli_connect("localhost:3307", "root", ""); // Buradaki adı mysqli_select_db() bölümüne koyduk.
	if(mysqli_connect_errno()){
		echo "Veritabanına Baglanilmadi." . "<br>";
		echo mysqli_connect_error();
	}else{
		echo "Veritabanına Baglanildi.";
		mysqli_set_charset($VeritabaniBaglantisi, "UTF-8");
		mysqli_select_db($VeritabaniBaglantisi, "cahrion"); // Burada.
