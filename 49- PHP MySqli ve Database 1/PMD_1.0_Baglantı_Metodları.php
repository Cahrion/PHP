...
<body>
	...
	*/
	...
	$VeritabaniBaglantisi 		= mysqli_connect($VeritabaniHostAdresi, $VeritabaniHostKullaniciAdi, $VeritabaniHostSifresi, $VeritabaniAdi);
	mysqli_set_charset($VeritabaniBaglantisi, "UTF-8"); // Getirilirken hangi karakterde olması seçilir.
