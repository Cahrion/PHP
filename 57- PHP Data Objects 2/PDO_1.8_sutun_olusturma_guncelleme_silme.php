...
<body>
	...
	*/
	...
	CHANGE dogumtarihi dogumyili int(4) UNSIGNED NOT NULL,
	CHANGE sitemizineredenduydunuz referans int(7) UNSIGNED NOT NULL  
	");  // Birden fazla yapı da değiştirilebilir.
		if($Sorgu){
