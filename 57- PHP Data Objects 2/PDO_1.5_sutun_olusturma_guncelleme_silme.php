...
<body>
	...
	*/
	...
	// exec() yapısıyla bir tane yapalım (Diğer yapılarda exec yapısında çalışır ama biz bir tane örnek verelim)
	...
	"); // Sırasıyla yükleme yapıldığı için "," den öncekini bile çağırabiliriz bu sayede peş peşe eklenmiş olur.
		if($Sorgu !== false){
