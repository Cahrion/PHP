...
<body>
	...
	*/
	...
	// exec() yapısıyla örnek olsun diye geriye döndürelim. (query yapısıyla da geriye döndürülebilir.)
	
	$Sorgu 	= $VeritabaniBaglantisi->exec("ALTER TABLE kisiler 
	MODIFY dogumtarihi smallint(4) UNSIGNED NOT NULL,
	MODIFY sitemizineredenduydunuz varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL  
	");  
		if($Sorgu !== false){
