...
<body>
	...
	*/
	...
	// exec() yapısıyla geriye döndürelim.
	
	$Sorgu 	= $VeritabaniBaglantisi->exec("ALTER TABLE kisiler 
	CHANGE dogumyili dogumtarihi smallint(4) NOT NULL,
	CHANGE referans sitemizineredenduydunuz varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL 
	");  // dogumyili yapısını geriye çevirdik.
		if($Sorgu !== false){
