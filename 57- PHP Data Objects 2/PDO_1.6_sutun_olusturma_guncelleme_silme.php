...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("ALTER TABLE kisiler CHANGE dogumtarihi dogumyili int(4) UNSIGNED NOT NULL");  // dogumyarihi adlı yapıyı dogumyili olarak değiştirip yapısınıda int(4) yani 4 karakterlik int yapısı, UNSIGNED (işaretsiz) ve değer belirtmemesi yaptık (NOT NULL) 
		if($Sorgu){
