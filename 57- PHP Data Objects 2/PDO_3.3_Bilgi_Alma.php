...
<body>
	...
	*/
	...
	// exec() yapısıylada yapılabilir biz bir tanesini yapalım.
	
	$Sorgu 	= $VeritabaniBaglantisi->exec("SHOW TABLES FROM cahrion"); // SHOW TABLES exec yapısında çalışmaz hatalı bir yapı olur.
	if($Sorgu !== false){
		echo "Database içerisinde bulunan tüm tablolar: <br>";
