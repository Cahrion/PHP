...
<body>
	...
	*/
	...
	$Sorgu 		= $VeritabaniBaglantisi->query("SELECT * FROM uyeler")->fetch(PDO::FETCH_OBJ); // Sütun adlarıyla anahtar tanımlanır ama nesne olarak çekilir.
	if($Sorgu){
		...
		echo $Sorgu->isim . " | ";
		echo $Sorgu->yas . " | ";
		echo $Sorgu->beceriler . " | ";
		echo $Sorgu->beceriseviyeleri . " <br> ";
	}else{
		echo "Sorgu Hatası";
	}
