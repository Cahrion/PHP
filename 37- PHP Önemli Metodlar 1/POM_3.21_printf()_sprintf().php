...
<body>
	...
	*/
	...
	printf("Değerin Bilimsel Gösterim Karşılığı %E", $Metin); // Bilimsel gösterimde e harfinin büyük yazmasını istiyorsak büyük "E" yapılır.
	
	echo "<br>";	
	$Deger 	= sprintf("Değerin Bilimsel Gösterim Karşılığı %E", $Metin);
	echo $Deger;
