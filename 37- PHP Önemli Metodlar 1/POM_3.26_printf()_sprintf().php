...
<body>
	...
	*/
	...
	printf("%30s", $Metin); // Bu yazım kaynağın önüne istenen kadar karakter olması için metinine ek olarak boşluk bırakır ekranda gözükmez ama incelerken gözükür.
	
	echo "<br>";	
	$Deger 	= sprintf("%30s", $Metin);
	echo $Deger;
