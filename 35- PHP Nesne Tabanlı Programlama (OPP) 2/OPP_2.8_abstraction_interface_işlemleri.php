...
<body>
	...
	*/
	...
	interface Tema{
		...
		public function Deney(); // Public bir function içerebilir.
		
		public $Isim 			= "Icabi"; // Public özellikler içeremez.
		private $Yas			= "19"; // private içeremez.
		protected $DogumYeri	= "Istanbul"; // protected içermez
	}	
	
	class UstAlan implements Tema{
