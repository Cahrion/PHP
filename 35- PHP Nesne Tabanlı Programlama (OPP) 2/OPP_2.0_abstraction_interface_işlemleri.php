...
<body>
	...
	*/
	...
	abstract class Deneme{
		abstract public function Tanim($Parametre); // Hata Kodu döndürür, çünkü soyut sınıf içerisinde bulunan metodlar muhakkak soyut sınıftan türeyen alt sınıflarda da bulunmalıdır.
	}	
