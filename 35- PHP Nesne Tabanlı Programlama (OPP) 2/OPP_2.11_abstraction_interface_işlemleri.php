...
<body>
	...
	*/
	...
	class UstAlan extends Tema implements CRUD{ 
		// Yazım sırası önce abstract maddesi eklenir sonrasında implementsle arayüz eklenebilir. Farklı gösterim hata döndürür.
		// İki tane soyut yapıyı içinde barındırabilir. (interface ve abstract)
		
		
		// Tema (abstract) yapısından gelen zorunlu metodlar.
		public function HeaderAlani($ArkaPlanRengi, $HeaderLogosu, $HeaderBanneri){
		}
		// CRUD (interface) yapısından gelen zorunlu metodlar.
		public function Olusturma($TabloDegeri, $ID){
