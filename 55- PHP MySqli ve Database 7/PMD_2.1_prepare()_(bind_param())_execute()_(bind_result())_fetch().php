...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->prepare("SELECT adisoyadi, emailadresi, yas FROM kisiler"); // İstenilen verilerde alınabilir.
	if($Sorgu){
		$Sorgu->execute(); 
		$Sorgu->bind_Result($KayitIsimSoyisim, $KayitEmaili, $KayitYas); 
