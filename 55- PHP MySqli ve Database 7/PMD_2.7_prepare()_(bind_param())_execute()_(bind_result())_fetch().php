...
<body>
	...
	*/
	...
	$Guncelle 	= $VeritabaniBaglantisi->prepare("UPDATE kisiler SET 
	adisoyadi='DegisenAd', emailadresi='deneme@extraegitim', sehir='Deneme Şehri'
	WHERE id>7");  
	
	if($Guncelle){
		
		$Guncelle->execute();  // Bu yapıyla guncelleme işlemide yapabiliriz.
		if($Guncelle){
