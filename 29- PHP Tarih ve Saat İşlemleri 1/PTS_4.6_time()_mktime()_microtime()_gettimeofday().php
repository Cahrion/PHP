...
<body>
	...
	$Deger 		=	gettimeofday(true); // true yazıldığında string şeklinde bir döndürme yapar.  
	
		echo $Deger . "<br>"; // Zaman damgası ve mikro saniye verisini verir.
	
	$Dizi 		= explode(".",$Deger);
	
		echo "Zaman damgası: " . $Dizi[0] . "<br>";
		echo "Mikro saniye : " . $Dizi[1];
