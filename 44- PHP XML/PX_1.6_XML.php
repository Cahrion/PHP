...
<body>
	...
	*/
	...
	<ACIKLAMA>Küçük işaretinin simgesi : < , büyük işaretinin simgesi: > olarak yazılmaktadır.</ACIKLAMA>
	</root>';
	
	$Donustur 	= simplexml_load_string($Deger); // Hata kodu üretir, çünkü XMl içeriğinde < veya > işaretleri gibi karakter kullanmak hata gönderir.
	// Çözümü --> PX_1.7_XML.php
