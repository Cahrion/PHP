...
header("Content-type: text/xml; charset=UTF-8");
	...
	*/
	...
	$Islem->loadXML($Sonuc);
	$Islem->preserveWhiteSpace  = false; 	// Boşlukları yok etti.
	$Islem->formatOutput  		= true; 	// Girinti oluşturdu.
	$Islem->xmlVersion 			= "1.0";	// XML versiyonu ayarlandı.
	$Islem->encoding 			= "UTF-8";	// Dil ayarlandı.
//  echo $Islem->saveXML();
	$Islem->save($Dosya);
?>