...
<?php 
	...
	*/
	...
	define("SOYISIM", "Kırgız"); // Hata !- çünkü sabitler bir daha değişken verilerek değiştirilemezler
	define("SOYISIM", "Kahraman");
	echo SOYISIM;
	const YAS 	= 19;
	const YAS 	= 20;
	echo YAS; // Hata !- çünkü sabitler bir daha değişken verilerek değiştirilemezler
