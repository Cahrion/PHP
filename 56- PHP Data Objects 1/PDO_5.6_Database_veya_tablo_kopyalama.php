...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("CREATE TABLE cahrion.ornekyedek LIKE timetube.ornek");  // "timetube" veritabanındaki "ornek" adındaki tabloyu "cahrion" veritabanında "ornekyedek" adında kopyaladı.  (Verileri almaz sadece tabloyu kopyalar.)
		if($Sorgu){
