...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->exec("SELECT * FROM kisiler"); // exec() Metodu SELECT İşlemleriinde kullanılmamalıdır SELECT işlemlerinde query() metodu tercih edilmelidir.
