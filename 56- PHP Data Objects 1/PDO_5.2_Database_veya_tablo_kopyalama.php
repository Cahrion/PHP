...
<body>
	...
	*/
	...
	// Bu yapıların ikisini de exec() yapısıyla yapılabilir biz bir tanesini yapalım.
	$Sorgu 	= $VeritabaniBaglantisi->exec("CREATE DATABASE timetube CHARACTER SET utf8 COLLATE utf8_general_ci"); 
	
		if($Sorgu !== false){ // Denklik belirtilmeli yoksa çalışmaz.
