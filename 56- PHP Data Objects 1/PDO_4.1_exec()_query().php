...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kisiler", PDO::FETCH_ASSOC);  // aslında yapısı değişti ama gözükmek döngü gereklidir. (İlerleyen derslerde anlatılıcak.)
