...
<body>
	...
	*/
	...
	$Sonuc 		= substr($Icerik, 6); //  6. karakterden başlayarak sonuna kadar aldı ve geriye döndürdü. 	 (Türkçe karakterler 2 olarak alınır.)
	$mb_Sonuc 	= mb_substr($Icerik, 6); //  6. karakterden başlayarak sonuna kadar aldı ve geriye döndürdü. (Türkçe karakterler 1 olarak alınır.)
