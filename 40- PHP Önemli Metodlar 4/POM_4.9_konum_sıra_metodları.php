...
<body>
	...
	*/
	...
	$Sonuc 		= strripos($Icerik, "p");  	 // Türkçe karakterler 2 karakter olarak sayılır. (Sondan Başlar)
	$SonucTR 	= mb_strripos($Icerik, "p"); // Türkçe karakterler 1 karakter olarak sayılır. (Sondan Başlar)
