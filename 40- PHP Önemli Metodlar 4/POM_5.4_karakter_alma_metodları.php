...
<body>
	...
	*/
	...
	$mb_Sonuc 	= mb_substr($Icerik, -10, 3, "UTF-8"); // Sondan 10. karakterden başladı 3 karakter aldı.  (Türkçe karakterler 1 olarak alınır.)
	
	// (mb_substr() parametresi UTF-8 parametresi sona eklenebilir doğru kullanım olarak geçer. Kullanılmazsa serverin kodlanmasını alır.)
