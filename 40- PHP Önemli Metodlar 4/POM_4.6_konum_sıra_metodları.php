...
<body>
	...
	*/
	...
	$Sonuc 		= strrpos($Icerik, "e"); 		// Türkçe karakterler 2 karakter olarak sayılır. (Sondan Başlar)
	$SonucTR 	= mb_strrpos($Icerik, "e"); 	// Türkçe karakterler 1 karakter olarak sayılır. (Sondan Başlar)
