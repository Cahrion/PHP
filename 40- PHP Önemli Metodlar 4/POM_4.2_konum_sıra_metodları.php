...
<body>
	...
	*/
	...
	$Sonuc 		= strpos($Icerik, "m", 8); // 8. Karakterden başlar. Kontrol etmeye ama geriye döndürdüğü değer baştan başlar.
	$SonucTR 	= mb_strpos($Icerik, "m", 8, "UTF-8"); // 4. parametre nasıl bir dille yazılması gerektiğini gösterir.
	// 8. Karakterden başlar. Kontrol etmeye ama geriye döndürdüğü değer baştan başlar.
