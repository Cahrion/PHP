...
<body>
	...
	*/
	$Deger 	= "Veriler\Veri.ini"; // İstenirse kendi ini dosyalarınızıda görebilirsiniz.
	
	echo "<pre>";
	print_r(parse_ini_file($Deger));
	echo "</pre>";
	
	echo "Uzun yazar.";
	
	echo "<pre>";
	print_r(parse_ini_file($Deger, true)); // true değeri girince uzun yazar.
	echo "</pre>";
