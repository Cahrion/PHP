...
<body>
	...
	*/
	...
	echo "İstediğimizi de okuyabiliriz. <br><br>";
	
	echo "<pre>";
	print_r(ini_get_all("mysqli", false)); // "false" yaparsak kısa şekilde yazar.
	echo "</pre>";

	echo "Uzun yazılmış hali";
	
	echo "<pre>";
	print_r(ini_get_all("mysqli"));
	echo "</pre>";
