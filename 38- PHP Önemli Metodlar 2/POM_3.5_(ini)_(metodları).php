...
<body>
	...
	*/
	...
	$Deger 		= "display_errors";
	echo $Deger . " değeri: " . ini_get($Deger) . "<br>";
	
	ini_set($Deger, 0); // açık olan bir şeyi kapattık.  ||| Bazı şeylere müsaade etmez.
	echo $Deger . " değeri: " . ini_get($Deger) . "<br>";
	
	ini_restore($Deger); // Varsayılan haline geri döndürür.
	echo $Deger . " değeri: " . ini_get($Deger);
