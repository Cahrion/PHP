...
<body>
	...
	*/
	...
	$Sonuc 	= new Deney; // Nesne şekline girince get_object_vars() verisi çalışır.
		
	echo "<pre>";
	print_r(get_object_vars($Sonuc)); // Sisteme tanımlı sınıfın içindeki verileri gösterir. (Değişkenler, public)
	echo "</pre>";
