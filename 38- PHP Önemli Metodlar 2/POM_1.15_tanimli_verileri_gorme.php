...
<body>
	...
	*/
	...
	class Deney{
		var $IsimSoyisim 		= "Icabi Kırgız";
		public const YAS		= 19;
		
		private $YazilimciBir	= "Icabi";
		protected $YazilimciIki	= "Umut";
		public $YazilimciUc		= "Aslı";
		static $YazilimciDOrt	= "Hakan";
		private function IslevBir() { }
		protected function IslevIki() { }
		public function IslevUc() { }
		static function IslevDort() { }
	}
	
	$Islem = new Deney; // Bu şekilde de kullanılabilir.
		
	echo "<pre>";
	print_r(get_class_methods($Islem)); // Sisteme tanımlı sınıfın içindeki verileri gösterir. (methodları geriye döndürür. -> public, statik olanları)
	echo "</pre>";
