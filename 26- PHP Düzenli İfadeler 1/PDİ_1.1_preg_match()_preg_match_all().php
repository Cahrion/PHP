...
<body>
	...
	preg_match_all($Desen, $Metin, $Sonuc); // Desen(1) metinde(2) aranır. Çıkan sonuç "Sonuç"(3) listesine yazılır.
	
		echo "<pre>";
		print_r($Sonuc);
		echo "</pre>";
	
	// Ici dolu olduğu için içerik var der (Kullanılmaz çünkü içinde olmayada bilir.)
