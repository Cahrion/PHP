...
<body>
	<?php
		/*
			$	 	=	Düzenli ifade dahilinde kontrol edilecek olan içerigin,karakter diziliminin sonu ile düzenli ifade arasında eşleşme aramak için kullanılır.
		*/
	...
	$Desen		= "/PHP$/"; // ($) Sonda neyle başladığını bakmak için kullanılır
