...
<body>
	...
	*/
	...
	$Icerik 			= "Benim adım Icabi Kırgız. Ben bir JavaScript yazılımcısıyım"; 
	
	echo $Icerik . "<br>";
	
	$Arananlar 			= array("icabi kırgız", "javaScript", "yazılımcısıyım");
	$Degistirilecekler 	= array("Can Kırgız", "C#", "programcısıyım");
	$Islem 				= str_ireplace($Arananlar, $Degistirilecekler, $Icerik, $Sayi); // str_ireplace() => Büyük harf küçük harf duyarlılığını siler.
	
	echo $Islem . "<br>";
	echo "Kaç adet değişim yapıldı: " . $Sayi;
