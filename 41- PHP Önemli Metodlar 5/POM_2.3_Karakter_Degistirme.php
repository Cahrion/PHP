...
<body>
	...
	*/
	...
	$Dizi 				= array("Icabi Kırgız" => "Can Kırgız", "JavaScript" => "C#", "yazılımcısıyım"=> "programcısıyım");
	$Islem 				= strtr($Icerik, $Dizi); // Tek bir diziyle anahtarları elemanlarlarla değiştirirler.
