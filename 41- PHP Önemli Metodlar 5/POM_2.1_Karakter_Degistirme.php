...
<body>
	...
	*/
	...
	$Arananlar 			= array("Icabi Kırgız", "JavaScript");
	$Degistirilecekler 	= array("Can Kırgız", "C#");
	$Islem 				= str_replace($Arananlar, $Degistirilecekler, $Icerik, $Sayi); // Son parametre kaç tane değiştiyse onu yazar.
