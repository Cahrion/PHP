...
<body>
	...
	$Dizin 			= "./Harici/*.php"; // sadece php ile bitenleri getirdi.
	
	$Listele 		= glob($Dizin, GLOB_BRACE); 
		echo "(./Harici/*.php) parametresi ve GLOB_BRACE parametresi";
		echo "<pre>";
		print_r($Listele);
		echo "</pre><br><br>";
	
	$Dizin 			= "*.{rar,txt}"; // sadece rar ve txt ile bitenleri getirdi.
	
	$Listele 		= glob($Dizin, GLOB_BRACE); 
		echo "(*.{rar,txt}) parametresi ve GLOB_BRACE parametresi";
		echo "<pre>";
		print_r($Listele);
		echo "</pre><br><br>";
