...
<body>
	...
	$Dosya 		= "Cahrion.txt"; 
	$Olustur	= touch($Dosya); // verilen isme göre dosya oluşturur. (Aynı adlı bir dosya varsa o dosyaya dokunmaz)
	
	if($Olustur == 1){ // Boolean (Mantıksal) veri sınanabilir.
		echo "Dosya başarıyla oluşturuldu.";
	}else{
		echo "Dosya oluşturulma işlemi sırasında hata oluştu.";
	}
