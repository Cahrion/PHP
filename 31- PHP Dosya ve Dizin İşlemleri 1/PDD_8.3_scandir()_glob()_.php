...
<body>
	...
	$Listele 		= glob($Dizin, GLOB_MARK); // Dizinlerin sağına "\" ekler
		echo "(*) parametresi ve GLOB_MARK parametresi";
		echo "<pre>";
		print_r($Listele);
		echo "</pre><br><br>";
	...
	$Listele 		= glob($Dizin, GLOB_NOSORT); // Dosya sıralamasını dosya ve dizin değerlerine bakmaz.
		echo "(*) parametresi ve GLOB_NOSORT parametresi"; 
		echo "<pre>";
		print_r($Listele);
		echo "</pre><br><br>";
