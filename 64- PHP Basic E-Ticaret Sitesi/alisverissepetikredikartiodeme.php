...
if(isset($_SESSION["Kullanici"])){
	...
	if($SepettekiUrunSayisi>0){
		...
		$okUrl			=	"http://127.0.0.1/AstroGorya/alisverissepetikredikartiodemesonuctamam.php";	//	Ödeme İşlemi Başarıyla Gerçekleşir ise Dönülecek Sayfa
		$failUrl		=	"http://127.0.0.1/AstroGorya/alisverissepetikredikartiodemesonuchata.php";	//	Ödeme İşlemi Red Olur ise Dönülecek Sayfa
		$rnd			=	@microtime();
