<?php
if(isset($_GET["ID"])){
$GelenID		=	SayiliIcerikleriFiltrele(GuvenlikFiltresi($_GET["ID"]));
		...
		<td width="350" valign="top"><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="78" style="border: 1px solid #CCCCCC;cursor: pointer;"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>" width="78" height="104" border="0" onClick="FotografDegistir(this);"></td><td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;cursor: pointer;"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"]); ?>" width="78" height="104" border="0" onClick="FotografDegistir(this);"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
						<td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;cursor: pointer;"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"]); ?>" width="78" height="104" border="0" onClick="FotografDegistir(this);"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
						<td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]!="")){ ?><td width="78" style="border: 1px solid #CCCCCC;cursor: pointer;"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]); ?>" width="78" height="104" border="0" onClick="FotografDegistir(this);"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
					</tr>
				</table></td>
			</tr>
			<tr>
						...
						<td width="30">
							<?php 
								if(isset($_SESSION["Kullanici"])){ 
									$FavorilerGosterimSorgusu			=	$VeritabaniBaglantisi->prepare("SELECT * FROM favoriler WHERE UrunId = ? AND UyeId = ?");
									$FavorilerGosterimSorgusu->execute([$GelenID, $KullaniciID]);
									$FavorilerGosterimSorgusuSayisi		=	$FavorilerGosterimSorgusu->rowCount();
									if($FavorilerGosterimSorgusuSayisi > 0){
										$FavorilerDahilinde 			= "KalpKirmiziDaireliBeyaz24x24_secili.png";
									}else{
										$FavorilerDahilinde 			= "KalpKirmiziDaireliBeyaz24x24.png";
									}
							?>
							<a href="index.php?SK=87&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>">
								<img src="Resimler/<?php echo $FavorilerDahilinde; ?>" border="0" style="margin-top: 5px;">
							</a>
