...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold;background-color: grey"><a href="index.php?SK=59" style="text-decoration: none; color: white;">Favoriler</a></td>
		<td width="10">&nbsp;</td>
