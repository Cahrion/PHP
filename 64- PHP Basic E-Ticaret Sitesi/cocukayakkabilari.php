...
if(isset($_REQUEST["MenuID"])){
	$GelenMenuId		=	SayiliIcerikleriFiltrele(GuvenlikFiltresi($_REQUEST["MenuID"]));
...
if(isset($_REQUEST["AramaIcerigi"])){
	$GelenAramaIcerigi	=	GuvenlikFiltresi($_REQUEST["AramaIcerigi"]);
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="250" align="left" valign="top"><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
						...
						<tr height="30">
							<td><a href="index.php?SK=86" style="text-decoration: none; <?php if($GelenMenuId==""){ ?>color: #FF9900;<?php }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler (<?php echo $AnaMenununTumUrunSayiSorgusu["MenununToplamUrunu"]; ?>)</a></td>
						</tr>
					<?php
					...
					?>
						<tr height="30">
							<td><a href="index.php?SK=86&MenuID=<?php echo $Menu["id"]; ?>" style="text-decoration: none;<?php if($GelenMenuId==$Menu["id"]){ ?>color: #FF9900;<?php }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;<?php echo DonusumleriGeriDondur($Menu["MenuAdi"]); ?> (<?php echo DonusumleriGeriDondur($Menu["UrunSayisi"]); ?>)</a></td>
						</tr>
					<?php
					}
					?>
		...
		<td width="795" align="left" valign="top"><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><div class="AramaAlani"><form action="index.php?SK=86" method="post">
					<?php
					if($GelenMenuId!=""){
					?>
			...
			<tr>
				<td><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr><?php
						$UrunlerSorgusu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Çocuk Ayakkabısı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
						...
						?>
							<td width="191" valign="top">
								<table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- border: 1px solid #CCCCCC; -->
									<tr height="40">
										<td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="Resimler/UrunResimleri/Cocuk/<?php echo DonusumleriGeriDondur($Kayit["UrunResmiBir"]); ?>" border="0" width="185" height="247"></a></td>
									</tr>
									<tr height="25">
										<td width="191" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>" style="color: #FF9900; font-weight: bold; text-decoration: none;">Çocuk Ayakkabısı</a></td>
									</tr>
									<tr height="25">
