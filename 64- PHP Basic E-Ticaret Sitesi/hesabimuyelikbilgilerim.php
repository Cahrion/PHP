...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold;background-color: gray"><a href="index.php?SK=50" style="text-decoration: none; color: white;">Üyelik Bilgileri</a></td>
		<td width="10">&nbsp;</td>
	...
	<tr>
		<td width="500" valign="top">
			<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30">
					<td valign="top" align="left"><?php echo $KullaniciIsimSoyisim; ?></td>
				</tr>
				<tr height="30">
					<td valign="bottom" align="left"><b>Cinsiyet</b></td>
				</tr>
				<tr height="30">
					<td valign="top" align="left"><?php echo $KullaniciCinsiyet; ?></td>
				</tr>
				<tr height="30">
					<td valign="bottom" align="left"><b>E-Mail Adresi</b></td>
				</tr>
				<tr height="30">
					<td valign="top" align="left"><?php echo $KullaniciEmailAdresi; ?></td>
				</tr>
				<tr height="30">
					<td valign="bottom" align="left"><b>Telefon Numarası</b></td>
				</tr>
				<tr height="30">
					<td valign="top" align="left"><?php echo $KullaniciTelefonNumarasi; ?></td>
				</tr>
				<tr height="30">
					<td valign="bottom" align="left"><b>Kayıt Tarihi</b></td>
				</tr>
				<tr height="30">
					<td valign="top" align="left"><?php echo TarihBul($KullaniciKayitTarihi); ?></td>
				</tr>
				<tr height="30">
					<td valign="bottom" align="left"><b>Kayıt IP</b></td>
				</tr>
				<tr height="30">
					<td valign="top" align="left"><?php echo $KullaniciKayitIpAdresi; ?></td>
				</tr>
				<tr height="30">
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="30">
				<td valign="top" style="border-bottom: 1px dashed #CCCCCC;">AstroGorya.com Reklamları.</td>
			</tr>
			<tr height="5">
				<td height="5" style="font-size: 5px;">&nbsp;</td>
			</tr>
			<tr>
				<td><img src="Resimler/ReklamResmi552x350.jpg" border="0"></td>
			</tr>
		</table></td>
	</tr>
</table>	
