...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold;background-color: grey"><a href="index.php?SK=58" style="text-decoration: none; color: white;">Adresler</a></td>
		<td width="10">&nbsp;</td>
			...
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				?>
					<tr height="50" bgcolor="<?php echo $ArkaplanRengi; ?>">
						<td align="left" style="padding-left: 5px"><?php echo $Satirlar["AdiSoyadi"]; ?> - <?php echo $Satirlar["Adres"]; ?> <?php echo $Satirlar["Ilce"]; ?> / <?php echo $Satirlar["Sehir"]; ?> - <?php echo $Satirlar["TelefonNumarasi"]; ?></td>
