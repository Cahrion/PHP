...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="10">&nbsp;</td>
		<td width="203" style="border: 1px solid black; text-align: center; padding: 10px 0; font-weight: bold;background-color: grey"><a href="index.php?SK=60" style="text-decoration: none; color: white;">Yorumlar</a></td>
		<td width="10">&nbsp;</td>
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30">
					<td colspan="3" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Yorumlarınız Bu Alandan Görüntüleyebilirsiniz.</td>
				</tr>
				<tr height="50">
					...
					<td width="75" align='right' style="background: #f8ffa7; color: black;" align="left">Yorum Tarihi&nbsp;</td>
				</tr>
				<?php
				...
				?>
						<tr>
							...
							<td width="845" align="left" style="border-bottom: 1px dashed #CCCCCC; padding: 15px 0px;" valign="top"><?php echo DonusumleriGeriDondur($Satirlar["YorumMetni"]); ?></td>
							<td width="135" align="right" style="border-bottom: 1px dashed #CCCCCC; padding: 15px 0px;" valign="top"><?php echo TarihBul($Satirlar["YorumTarihi"]); ?></td>
						</tr>
				<?php	
						}
