...
if(isset($_POST["SozlesmeOnay"])){
	$GelenSozlesmeOnay		=	GuvenlikFiltresi($_POST["SozlesmeOnay"]);
}else{
	$GelenSozlesmeOnay		=	"";
}
...
if(($GelenEmailAdresi!="") and ($GelenSifre!="") and ($GelenSifreTekrar!="") and ($GelenIsimSoyisim!="") and ($GelenTelefonNumarasi!="") and ($GelenCinsiyet=="Kadın" or $GelenCinsiyet=="Erkek")){
