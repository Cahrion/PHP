				...
				<tr height="100">
					<td valign="bottom" align="left"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="150" style="border-bottom: 1px dashed #CCCCCC;" align="right"><?php echo $UrunFiyatiBicimlendir; ?> TL<br /><?php if($SepettekiUrununAdedi != 1){ echo "<sup style='color:red;'>" . $SepettekiUrununAdedi . "x</sup> " . $UrunToplamFiyatiBicimlendir . " TL"; } ?></td>
						</tr>
					</table></td>
				</tr>
				<?php
