...
if(isset($_SESSION["Yonetici"])){
	if(isset($_POST["UrunMenusu"])){
		$GelenUrunMenusu			=	GuvenlikFiltresi($_POST["UrunMenusu"]);
	}else{
		$GelenUrunMenusu			=	"";
	}
	...
	if(isset($_POST["KdvOrani"])){
		$GelenKdvOrani				=	GuvenlikFiltresi($_POST["KdvOrani"]);
	}else{
		$GelenKdvOrani				=	"";
	}
	if(isset($_POST["KargoUcreti"])){
		$GelenKargoUcreti			=	GuvenlikFiltresi($_POST["KargoUcreti"]);
	}else{
		$GelenKargoUcreti			=	"";
	}
	if(isset($_POST["UrunAciklamasi"])){
		$GelenUrunAciklamasi		=	GuvenlikFiltresi($_POST["UrunAciklamasi"]);
	}else{
		$GelenUrunAciklamasi		=	"";
	}
	if(isset($_POST["VaryantBasligi"])){
		$GelenVaryantBasligi		=	GuvenlikFiltresi($_POST["VaryantBasligi"]);
	}else{
		$GelenVaryantBasligi		=	"";
	}
	if(isset($_POST["VaryantAdi1"])){
		$GelenVaryantAdi1			=	GuvenlikFiltresi($_POST["VaryantAdi1"]);
	}else{
		$GelenVaryantAdi1			=	"";
	}
	if(isset($_POST["StokAdedi1"])){
		$GelenStokAdedi1			=	GuvenlikFiltresi($_POST["StokAdedi1"]);
	}else{
		$GelenStokAdedi1			=	"";
	}
	if(isset($_POST["VaryantAdi2"])){
		$GelenVaryantAdi2			=	GuvenlikFiltresi($_POST["VaryantAdi2"]);
	}else{
		$GelenVaryantAdi2			=	"";
	}
	if(isset($_POST["StokAdedi2"])){
		$GelenStokAdedi2			=	GuvenlikFiltresi($_POST["StokAdedi2"]);
	}else{
		$GelenStokAdedi2			=	"";
	}
	if(isset($_POST["VaryantAdi3"])){
		$GelenVaryantAdi3			=	GuvenlikFiltresi($_POST["VaryantAdi3"]);
	}else{
		$GelenVaryantAdi3			=	"";
	}
	if(isset($_POST["StokAdedi3"])){
		$GelenStokAdedi3			=	GuvenlikFiltresi($_POST["StokAdedi3"]);
	}else{
		$GelenStokAdedi3			=	"";
	}
	if(isset($_POST["VaryantAdi4"])){
		$GelenVaryantAdi4			=	GuvenlikFiltresi($_POST["VaryantAdi4"]);
	}else{
		$GelenVaryantAdi4			=	"";
	}
	if(isset($_POST["StokAdedi4"])){
		$GelenStokAdedi4			=	GuvenlikFiltresi($_POST["StokAdedi4"]);
	}else{
		$GelenStokAdedi4			=	"";
	}
	if(isset($_POST["VaryantAdi5"])){
		$GelenVaryantAdi5			=	GuvenlikFiltresi($_POST["VaryantAdi5"]);
	}else{
		$GelenVaryantAdi5			=	"";
	}
	if(isset($_POST["StokAdedi5"])){
		$GelenStokAdedi5			=	GuvenlikFiltresi($_POST["StokAdedi5"]);
	}else{
		$GelenStokAdedi5			=	"";
	}
	if(isset($_POST["VaryantAdi6"])){
		$GelenVaryantAdi6			=	GuvenlikFiltresi($_POST["VaryantAdi6"]);
	}else{
		$GelenVaryantAdi6			=	"";
	}
	if(isset($_POST["StokAdedi6"])){
		$GelenStokAdedi6			=	GuvenlikFiltresi($_POST["StokAdedi6"]);
	}else{
		$GelenStokAdedi6			=	"";
	}
	if(isset($_POST["VaryantAdi7"])){
		$GelenVaryantAdi7			=	GuvenlikFiltresi($_POST["VaryantAdi7"]);
	}else{
		$GelenVaryantAdi7			=	"";
	}
	if(isset($_POST["StokAdedi7"])){
		$GelenStokAdedi7			=	GuvenlikFiltresi($_POST["StokAdedi7"]);
	}else{
		$GelenStokAdedi7			=	"";
	}
	if(isset($_POST["VaryantAdi8"])){
		$GelenVaryantAdi8			=	GuvenlikFiltresi($_POST["VaryantAdi8"]);
	}else{
		$GelenVaryantAdi8			=	"";
	}
	if(isset($_POST["StokAdedi8"])){
		$GelenStokAdedi8			=	GuvenlikFiltresi($_POST["StokAdedi8"]);
	}else{
		$GelenStokAdedi8			=	"";
	}
	if(isset($_POST["VaryantAdi9"])){
		$GelenVaryantAdi9			=	GuvenlikFiltresi($_POST["VaryantAdi9"]);
	}else{
		$GelenVaryantAdi9			=	"";
	}
	if(isset($_POST["StokAdedi9"])){
		$GelenStokAdedi9			=	GuvenlikFiltresi($_POST["StokAdedi9"]);
	}else{
		$GelenStokAdedi9			=	"";
	}
	if(isset($_POST["VaryantAdi10"])){
		$GelenVaryantAdi10			=	GuvenlikFiltresi($_POST["VaryantAdi10"]);
	}else{
		$GelenVaryantAdi10			=	"";
	}
	if(isset($_POST["StokAdedi10"])){
		$GelenStokAdedi10			=	GuvenlikFiltresi($_POST["StokAdedi10"]);
	}else{
		$GelenStokAdedi10			=	"";
	}
