			...
			<tr>
				<td width="200"><table width="200" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30" align="center">
						<td align="center"><table width="200" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr align="center">
								<td width="30" valign="top" align="right"><a href="index.php?SKD=0&SKI=14&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>"><img src="../Resimler/Guncelleme20x20.png" border="0"></a></td>
								<td width="61" valign="top"><a href="index.php?SKD=0&SKI=14&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>" style="color: #0000FF; text-decoration: none;">Güncelle</a></td>
								<td width="41" valign="top">&nbsp;</td>
								<td width="26" valign="top" align="center"><a href="index.php?SKD=0&SKI=18&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>"><img src="../Resimler/Sil20x20.png" border="0"></a></td>
								<td width="42" valign="top" align="left"><a href="index.php?SKD=0&SKI=18&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>" style="color: #FF0000; text-decoration: none;">Sil</a></td>
							</tr>
						</table></td>
					</tr>
				</table></td>
