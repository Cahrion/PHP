				...
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi1" class="EkleVeGuncelleInputAlanlari" value="<?php echo DonusumleriGeriDondur($VaryantIsimDizisi[0]); ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">1. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi1" class="EkleVeGuncelleInputAlanlari" value="<?php echo DonusumleriGeriDondur($VaryantStokDizisi[0]); ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi2" class="EkleVeGuncelleInputAlanlari" value="<?php echo $IkinciVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">2. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi2" class="EkleVeGuncelleInputAlanlari" value="<?php echo $IkinciVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi3" class="EkleVeGuncelleInputAlanlari" value="<?php echo $UcuncuVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">3. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi3" class="EkleVeGuncelleInputAlanlari" value="<?php echo $UcuncuVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi4" class="EkleVeGuncelleInputAlanlari" value="<?php echo $DorduncuVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">4. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi4" class="EkleVeGuncelleInputAlanlari" value="<?php echo $DorduncuVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi5" class="EkleVeGuncelleInputAlanlari" value="<?php echo $BesinciVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">5. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi5" class="EkleVeGuncelleInputAlanlari" value="<?php echo $BesinciVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi6" class="EkleVeGuncelleInputAlanlari" value="<?php echo $AltinciVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">6. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi6" class="EkleVeGuncelleInputAlanlari" value="<?php echo $AltinciVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi7" class="EkleVeGuncelleInputAlanlari" value="<?php echo $YedinciVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">7. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi7" class="EkleVeGuncelleInputAlanlari" value="<?php echo $YedinciVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi8" class="EkleVeGuncelleInputAlanlari" value="<?php echo $SekizinciVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">8. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi8" class="EkleVeGuncelleInputAlanlari" value="<?php echo $SekizinciVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi9" class="EkleVeGuncelleInputAlanlari" value="<?php echo $DokuzuncuVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">9. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi9" class="EkleVeGuncelleInputAlanlari" value="<?php echo $DokuzuncuVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3" align="left"><table width="728" align="left" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20">:</td>
							<td width="200"><input type="text" name="VaryantAdi10" class="EkleVeGuncelleInputAlanlari" value="<?php echo $OnuncuVaryantAdi; ?>"></td>
							<td width="20">&nbsp;</td>
							<td width="178">10. Varyant Stok Adedi</td>
							<td width="20">:</td>
							<td width="60"><input type="text" name="StokAdedi10" class="EkleVeGuncelleInputAlanlari" value="<?php echo $OnuncuVaryantStok; ?>"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
