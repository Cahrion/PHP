...
if(isset($_SESSION["Kullanici"])){
	if(isset($_POST["AdresSecimi"])){
		$GelenAdresSecimi		=	GuvenlikFiltresi($_POST["AdresSecimi"]);
	}else{
		$GelenAdresSecimi		=	"";
	}
	if(isset($_POST["KargoSecimi"])){
		$GelenKargoSecimi		=	GuvenlikFiltresi($_POST["KargoSecimi"]);
	}else{
		$GelenKargoSecimi		=	"";
	}
							...
							<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="390" align="left"><table width="400" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
										...
										<tr>
											<td align="center"><input id="Kredi" type="radio" name="OdemeTuruSecimi" value="Kredi Kartı" checked="checked" onClick="SecilenOdeme(this);"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										</tr>
									...
									<td width="390" align="left"><table width="400" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
										...
										<tr>
											<td align="center"><input id="Banka" type="radio" name="OdemeTuruSecimi" value="Banka Havalesi" onClick="SecilenOdeme(this);"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										</tr>
