...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE isim LIKE '%kan%'"); // "kan" kelimesi başındada olabilir sonunda da olabilir veya ortasında da olabilir demek.
		if($Sorgu){
