...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE FIND_IN_SET ('1', beceriseviyeleri)"); // İçerisinde "1" geçen tekil değerleri getirir. (91 olanları değilde sadece "1" bulunanları.)
		if($Sorgu){
