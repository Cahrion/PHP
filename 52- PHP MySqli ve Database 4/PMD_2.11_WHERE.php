...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE isim NOT IN ('Volkan','icabi')"); // isim değeri (icabi) ve (Volkan) değerlerine eşit olmayanları alır. 
		if($Sorgu){
