...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE yas NOT BETWEEN 30 AND 40");  // Minumum 30 olucak maksimum 40 olan verilerin haricindeki verileri getirir.
		if($Sorgu){
