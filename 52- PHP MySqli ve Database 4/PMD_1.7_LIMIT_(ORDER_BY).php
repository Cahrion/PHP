...
<body>
	...
	*/
	...
	$Sorgu 		= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler ORDER BY yas ASC, isim ASC"); // yas verisi küçükten büyüğe sıralanırken aynı yaş verisine sahip kişiler isim verisinin a'dan z'ye sırasına göre sıralanır. 
		if($Sorgu){
