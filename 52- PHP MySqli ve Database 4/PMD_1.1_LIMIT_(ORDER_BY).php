...
<body>
	...
	*/
	...
	$Sorgu 		= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler LIMIT 4, 2"); // 4. kayıttan başlar 2 kayıt alır. (Kayit 0'dan başlar. (5. kayit aslında 4.kayıt diye geçer.))
		if($Sorgu){
