...
<body>
	...
	*/
	...
	$Sorgu 		= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler ORDER BY isim ASC LIMIT 2"); // İlk başta A'dan Z'ye "isim" verisini dizer ondan sonra baştan 2 tanesini alır.
		if($Sorgu){
