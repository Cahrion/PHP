...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE beceriler NOT LIKE ('%Java%')");  // İçerisinde "Java" geçen bütün içerikleri haricindekileri gösterir.
		if($Sorgu){
