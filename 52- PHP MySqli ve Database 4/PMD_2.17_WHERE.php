...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE yas BETWEEN 30 AND 40");  // Minumum 30 olucak maksimum 40 olan verileri getirir (Sayısal verilerde kullanılır.)
		if($Sorgu){
