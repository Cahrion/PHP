...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE FIND_IN_SET ('Java', beceriler)"); // Tekil olarak kalan şekleri ele alır. (JavaScript gelmezken sadece "Java" gelir.)
		if($Sorgu){
