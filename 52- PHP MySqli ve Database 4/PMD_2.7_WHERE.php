...
<body>
	...
	*/
	...
	$Sorgu 	= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler WHERE isim NOT LIKE '%kan'"); // "kan" kelimesiyle başlayanları hariç diğerlerini alır. (% işaretinin yerine göre onlar olmayanları yani terslerini getirir.)
		if($Sorgu){
