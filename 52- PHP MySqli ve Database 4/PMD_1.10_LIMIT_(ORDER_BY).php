...
<body>
	...
	*/
	...
	$Sorgu 		= mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler ORDER BY isim ASC LIMIT 4, 2"); // İlk başta A'dan Z'ye "isim" verisini dizer ondan sonra 4. kayıttan başlar ve 2 tanesini ekler.
		if($Sorgu){
