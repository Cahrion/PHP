...
<body>
	...
	/*
		...
		~> query = www.icabi.com/sonuc.php?Ad=Icabi verisinin "?Ad=Icabi" kısmına verilen ad.
	*/
	
	$Deger 	= "https://extraegitim.com/sonuc.php?Ad=Icabi";
	
	if(filter_var($Deger, FILTER_VALIDATE_URL, FILTER_FLAG_QUERY_REQUIRED)){ // query olup olmadığına bakar.
