...
<body>
	...
	*/
	...
	$Deger 	= "3FFE:2800:2:1344:00FC:0AFF:FEFC:1022"; // IPV6 
	
	if(filter_var($Deger, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)){  // IPV6 türünde veriyi IPV4 sorgulamasına koyunca IP adresi değildir der.
