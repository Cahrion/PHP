...
<body>
	...
	*/
	...
	if(is_callable("Deney")){ 
		echo '"Deney" adındaki fonksiyon bir callable (geri çağırımlar / geri çağrılabilenler) içeriktir.';
	}else{
		echo '"Deney" adındaki fonksiyon bir callable (geri çağırımlar / geri çağrılabilenler) içerik değildir.';
	}
