...
<body>
	...
	/*
		...
		in_subclass_of() 	= Belirtilecek olan class (sınıf) yapısından tüyen, belirtilecek olan sub class'ın (alt sınıfın / miras alan) varlığını sınamak için kullanılır. Işlem sonucu daima boolean (mantıksal) veri türünde döner.
	...
	*/
	...
	if(function_exists("Deney")){ // Fonksiyon sorgusu
		echo '"Deney" adında bir fonksiyon vardır.';
	}else{
		echo '"Deney" adında bir fonksiyon yoktur.';
	}
