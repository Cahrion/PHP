...
<body>
	...
	*/
	...
	if(method_exists($Islem, "Deneme")){ // class içerisinde fonksiyon sorgusu
		echo '"Deney" adında bir class (sınıf) yapısının için "Deneme" adında fonksiyon vardır.';
	}else{
		echo '"Deney" adında bir class (sınıf) yapısının için "Deneme" adında fonksiyon yoktur.';
	}
