...
<body>
	...
	*/
	...
	$Dosya 	= fopen("Dokumanlar/Ornek.txt", "r"); 
	
	if(is_resource($Dosya)){ 
		echo '$Dosya adındaki değişkenin içeriği bir resource (kaynak) içeriktir.';
	}else{
		echo '$Dosya adındaki değişkenin içeriği bir resource (kaynak) içerik değildir.';
	}
	fclose($Dosya);
