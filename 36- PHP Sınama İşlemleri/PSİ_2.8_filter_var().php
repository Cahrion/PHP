...
<body>
	...
	*/
	...
	$Deger 	= "https://www.extraegitim.com"; // URL adresi
	
	if(filter_var($Deger, FILTER_VALIDATE_URL)){  // URL adresi olup olmadığını sorgular. ("https://" veya "http://" tagısı olmak zorundadır.)
