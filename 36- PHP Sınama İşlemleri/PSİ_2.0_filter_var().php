...
<body>
	...
	*/
	...
	if(filter_var($Deger, FILTER_VALIDATE_BOOLEAN)){ // Boolean veri mi değil mi sorulur.
		echo "Sınanan içerik boolean (mantıksal) veri türündedir .";
	}else{
		echo "Sınanan içerik boolean (mantıksal) veri türünde değildir.";
	}
