...
<body>
	...
	*/
	...
	if(property_exists($Islem, "Soyisim")){ // class içerisinde özellik sorgusu
		echo '"Deney" adında bir class (sınıf) yapısının için "Soyisim" adında özellik vardır.';
	}else{
		echo '"Deney" adında bir class (sınıf) yapısının için "Soyisim" adında özellik yoktur.';
	}
