...
<body>
	...
	*/
	...
	$Deger 	= "176.240.124.82"; // IPV4
	
	if(filter_var($Deger, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)){  // IPV4 türünde veriyi IPV6 sorgulamasına koyunca IP adresi değildir der.
