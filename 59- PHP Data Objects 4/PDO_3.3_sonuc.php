...
<body>
	...
	*/
	...
	$Ekle 		= $VeritabaniBaglantisi->query("INSERT INTO uyeler (isim, yas, beceriler, beceriseviyeleri) values ('" . $Gelenisim . "', '" . $Gelenyas ."', '" . $Gelenbeceriler . "', '" . $Gelenbeceriseviyesi . "')");
	if($Ekle){
		echo "Başarıyla eklendi.";
		header("Location: PDO_3.2_INSERT_INTO.php");
	}else{
		echo "Sorgu Hatası";
	}
