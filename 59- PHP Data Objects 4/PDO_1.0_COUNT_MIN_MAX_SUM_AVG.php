...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT COUNT(id) AS ToplamSatirSayisi FROM kayitlar"); // id sütununda kaç kayıt varsa bunu say diyor.
		if($Sorgu){
			$Kayit 	= $Sorgu->fetch();
			echo "Toplam Kayıt Sayısı: " . $Kayit["ToplamSatirSayisi"];
		}else{
			echo "Sorgu Hatası";
		}
