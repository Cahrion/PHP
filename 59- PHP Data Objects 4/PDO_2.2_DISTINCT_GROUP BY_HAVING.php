...
<body>
	...
	*/
	...
	$Sorgu 	= $VeritabaniBaglantisi->query("SELECT * FROM kayitlar GROUP BY sehir", PDO::FETCH_ASSOC);  // Bütün veriler gelir ve gruplar ama ASC yapısı da çalıştırır (ORDER BY = ASC) yapar otomatik.
		if($Sorgu){
